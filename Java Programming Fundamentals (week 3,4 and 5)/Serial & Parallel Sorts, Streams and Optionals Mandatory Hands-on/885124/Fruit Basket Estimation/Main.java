...
public class Main {
	...
	public static void main(String[] args) {
		...
		//List<FruitBasket> l1 = new ArrayList<>();
		//Stream<FruitBasket> fruitBasketStream = null ;
		do {
			...
			case 2:
				...
				System.out.println("The estimated bill amount is Rs "+utilObj.calculateBill(utilObj.getFruitBasketList().stream()));
				}
				break;
