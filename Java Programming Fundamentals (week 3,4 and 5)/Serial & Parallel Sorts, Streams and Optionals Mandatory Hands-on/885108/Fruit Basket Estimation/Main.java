	...
	public static void main(String[] args) {
		...
		do {
			...
			case 1:
				...
				break;
			case 2:Stream<FruitBasket> fruitBasketStream = utilObj.getFruitBasketList().stream();
			int count = utilObj.calculateBill(fruitBasketStream);
			if(count == -1) 
				System.out.println("Your basket is empty. Please add fruits.");
			else
				System.out.println("The estimated bill amount is Rs "+count);
				break;
			case 3:
