	...
	public static void main(String[] args) {
		...
		do {
			...
			case 1:
				...
				Stream <FruitBasket> fruitBasketStream;
				break;
			case 2:
				// Fill your code here
				if(utilObj.getFruitBasketList().isEmpty())
					...
					fruitBasketStream = utilObj.getFruitBasketList().stream();
					int calculateBill = utilObj.calculateBill(fruitBasketStream);
					System.out.println("The estimated bill amount is Rs " + calculateBill);
				}
				break;
