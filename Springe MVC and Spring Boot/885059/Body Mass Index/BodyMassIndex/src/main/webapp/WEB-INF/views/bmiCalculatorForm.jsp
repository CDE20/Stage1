	...
	<caption style="font-weight: bolder;">Body Mass Index Calculator Form</caption>
	    ...
	    <sf:form action="getBMI" modelAttribute="user" method="GET" name="form">
			<tr>
				...
				<tr>
				<td>Phone Number:</td>
				<td><sf:input id="phoneNumber" path="phoneNumber" /></td>
				<td><sf:errors path="phoneNumber" /></td>
			</tr>
				<tr>
				<td>Height in CM:</td>
			    <td><sf:input id="height" path="height" /></td>
			    <td><sf:errors path="height" /></td>
			</tr>
				
			<tr>
				<td>Weight in KG:</td>
				<td><sf:input id="weight" path="weight" /></td>
				<td><sf:errors path="weight" /></td>
			</tr>
			
			<tr>
				<td>Gender:</td>
				<td><sf:select id="genderType" path="genderType" items="${genderList}"/></td>
			</tr>
			<tr>
