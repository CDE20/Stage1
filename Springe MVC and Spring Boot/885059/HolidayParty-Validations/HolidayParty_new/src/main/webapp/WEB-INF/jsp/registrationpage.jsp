...
<form:form method="post" modelAttribute="register" action="/register">
    <table align="center">
			<tr>
				...
				<td><form:input name="userName" path="userName" id="userName" /></td>
				<td><form:errors path="userName"></form:errors></td>
			</tr>
			<tr>
				<td><form:label path="contactNumber">Contact Number</form:label></td>
				<td><form:input name="contactNumber" path="contactNumber" id="contactNumber" /></td>
				<td><form:errors path="contactNumber"></form:errors></td>
			</tr>
			<tr>
				<td><form:label path="emailId">Email Id</form:label></td>
				<td><form:input name="emailId" path="emailId" id="emailId" /></td>
				<td><form:errors path="emailId"></form:errors></td>
			</tr>
			<tr>
				<td><form:label path="confirmEmailId">Confirm Email Id</form:label></td>
				<td><form:input name="confirmEmailId" path="confirmEmailId" id="confirmEmailId" /></td>
				<td><form:errors path="confirmEmailId"></form:errors></td>
			</tr>
			<tr>
				<td><form:checkbox name="status" path="status" id="status" /></td>
				<td>I agree</td>
