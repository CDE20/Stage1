...
<body>
	...
	<table>
		...
		<sf:form action="/getBMI" modelAttribute="user" method="GET"
			...
			<tr>
				<td>Height in CM:</td>
				<td><sf:input path="height" type="text" name="height" id="height"/></td>
			...
			<tr>
				<td>Weight in KG:</td>
				<td><sf:input path="weight" type="text" name="weight" id="weight"/></td>
			...
			<tr>
				<td>Gender:</td>
				<td><sf:select path="genderType" id="genderType">
					<sf:options items="${genderList}"></sf:options>
					</sf:select></td>
					
				<td><sf:errors path="genderType"/>
