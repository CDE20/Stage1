...
public class RainbowJewellersService {
	...
	public static void main(String a[]){
		...
		System.out.println(new RainbowJewellersService().calculategoldprice(9.6));
		System.out.println(new RainbowJewellersService().calculategoldprice(56));
		System.out.println(new RainbowJewellersService().calculategoldprice(24.5));
		System.out.println(new RainbowJewellersService().calculategoldprice(0));
