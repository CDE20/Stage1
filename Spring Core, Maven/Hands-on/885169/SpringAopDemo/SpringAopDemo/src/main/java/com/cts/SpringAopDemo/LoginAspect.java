...
public class LoginAspect {
	...
	// Type your code here
	@Around("execution(* com.cts.SpringAopDemo.EasyBank.doWithdraw(int))")
	...
	// Type your code here
	@Before("execution(* com.cts.SpringAopDemo.EasyBank.doDeposit(..)) || execution(* com.cts.SpringAopDemo.EasyBank.showBalance())")
