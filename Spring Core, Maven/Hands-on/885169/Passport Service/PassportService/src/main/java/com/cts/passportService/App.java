...
public class App 
{
    public static void main( String[] args )
    {
    	...
    	if(choice==1){
    		...
    		//passport=(HeadPassportOffice)context.getBean("chennaiPassportOffice");
    	}else if(choice==2){
    		// Type your code here
    		//passport=(BanglorePassportOffice) context.getBean(BanglorePassportOffice.class);
    		//passportOffice = (BangalorePassportOffice) context.getBean(BangalorePassportOffice.class);
    		passport=(HeadPassportOffice)context.getBean("bangaloreDocument");
    	}else{
