	...
	public static void main(String[] args) {
		...
		case 1:
			...
			if (choice == 1) {
				...
				System.out.println("Your balance amount is " + numberFormat.format(acc.doDeposit(amt)));

			} else if (choice == 2) {
				// Do call Withdraw
				System.out.println("Enter amount to be withdrawn");
				double amt = scanner.nextDouble();
				System.out.println("Your balance amount is " + numberFormat.format(acc.doWithdraw(amt)));
		...
		case 2:
			...
			System.out.println("Your balance after " + t + " months will be "
					+ acc.calculateRecurringAccount(amt, t));
		...
		case 3:
			...
			System.out.println("Your balance after " + month + " months will be "
					+ acc.calculateFixedAccount(amt1, month));
			break;
